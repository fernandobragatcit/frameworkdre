...
class CrudLogDireitosGrupo extends AbsCruds {

    public function executa($get, $post, $file) {
        self::setXmlGrid(FWK_XML_CRUD . "gridLogDireitosGrupo.xml");
    ...
    private function exibeLog($id) {
        $stringAnt = "";
        $stringNovo = "";
        $arrLog = self::getObjLog()->getDadosLogDireitosGrupo($id);
        ...
        self::getObjSmarty()->assign("TITULO_FORMS", "Log de Direitos de Grupo");
        self::getObjSmarty()->assign("BTN_CANCELAR", "<a class='button' style='cursor:pointer;' onclick=\"return vaiPara('?c=" . self::getObjCrypt()->cryptData("CrudLogDireitosGrupo") . "');\" name=\"Voltar\">Voltar</a>");
