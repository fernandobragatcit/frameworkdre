	...
	private function registraOptions(){
		try{
			...
			if(!isset(self::getObjXmlCompDados()->classe) || self::getObjXmlCompDados()->classe == "")
				throw new ElementsException("N�o foi passado o parametro 'classe' para o componente AddBlocoCampos");

			if(!isset(self::getObjXmlCompDados()->caminho) || self::getObjXmlCompDados()->caminho == "")
				throw new ElementsException("N�o foi passado o parametro 'caminho' para o componente AddBlocoCampos");

			if(!isset(self::getObjXmlCompDados()->metodo) || self::getObjXmlCompDados()->metodo == "")
				throw new ElementsException("N�o foi passado o parametro 'metodo' para o componente AddBlocoCampos");
			...
			if(!file_exists($caminho.$classe.".class.php"))
				throw new ElementsException("N�o foi a classe passada no caminho correspondente para o componente AddBlocoCampos");
