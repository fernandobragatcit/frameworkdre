                                    ...
                                    {else}
                                        ...
                                        {/if}
                                            ...
                                            {elseif $ARR_LINHAS[per].tipo == 'select'}
                                                <select {if $ARR_LINHAS[per].class != ""} class="{$ARR_LINHAS[per].class}{if $ARR_LINHAS[per].contadorClass=="1"}{$id+1}{/if}"{else}style="width: 100%;"{/if} title="{$ARR_LINHAS[per].label}" name="{$IDCOMPONENTE}[{$id}][{$ARR_LINHAS[per].id}]"
                                                                                                                                                                                            ...
                                                                                                                                                                                            {section name=lin loop=$CONT_LINHAS}
                                                                                                                                                                                                {section name=per loop=$ARR_LINHAS}
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    {else}
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        {elseif $ARR_LINHAS[per].tipo == 'select'}
                                                                                                                                                                                                        <select {if $ARR_LINHAS[per].class != ""}class="{$ARR_LINHAS[per].class}{if $ARR_LINHAS[per].contadorClass=="1"}{$id+1}{/if}"{else}style="width: 100%;"{/if} title="{$ARR_LINHAS[per].label}" name="{$IDCOMPONENTE}[number][{$ARR_LINHAS[per].id}]"
