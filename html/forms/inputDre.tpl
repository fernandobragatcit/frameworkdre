<input type="{$TYPE_COMP}" name="{$NOME_COMP}" {$SIZE_COMP} {$ONKEYUP_COMP} {$ONKEYPRESS_COMP} {$ONFOCUS_COMP} {$ONKEYDOWN_COMP} {$ONKEYPRESS_COMP} id="{$ID_COMP}" {$STYLE_COMP} {$COMP_ONCLICK} {$ONBLUR_COMP}
