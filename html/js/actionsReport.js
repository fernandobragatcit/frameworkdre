...
addLoadEvent(function () {
   try{
   	sortableManager.initWithTable('tableReport');
   }catch(e){
   	//não foi construída a tabela, suprime-se o erro js aqui....
   }
...
function zebrarTrs(){
	jQuery("tr").removeClass("reportLin1");
	jQuery("tr").addClass("reportLin2");
	jQuery("tr:odd").removeClass("reportLin2");
	jQuery("tr:odd").addClass("reportLin1");
}
